...
```javascript
import rsqrtf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-rsqrtf@v0.2.4-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-rsqrtf/actions/workflows/test.yml/badge.svg?branch=v0.2.4
[test-url]: https://github.com/stdlib-js/math-base-special-rsqrtf/actions/workflows/test.yml?query=branch:v0.2.4
